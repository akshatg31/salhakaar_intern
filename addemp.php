...
if(isset($_POST['submit']))
    {
        ...
        {
            $sql = "INSERT INTO employee (name, email, department, password, employeeID) VALUES ('$name', '$email', '$department', '$password', '$employeeID' , '$contact')";
        ...
        <div class="p-4">
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="employeeID" class="form-control" id="exampleInputemployeeID" placeholder="Employee ID">
                </div>
